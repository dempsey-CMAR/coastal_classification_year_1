...
In this analysis, heat stress occurs for 24 hours after any temperature observation ≥ `r high_temperature` °C, and a heat stress event is a continuous period of heat stress at a given station and depth [@RN27145].
...
The Coastal Monitoring Program temperature data series cover different time periods depending on the station and depth measured. To compare results between stations, only data series covering potential heat stress months were included in the analysis. Potential heat stress months were defined as July, August, and September, as for the salmon and trout analyses.

The only temperature observations greater than `r high_temperature` were in August 2018 in Deep Basin, Inverness (@fig-heat-stress-year). This station was filtered out of the analysis because it is missing data for the whole month of July.

...
#| fig-cap: Superchill likelihood at each station. Use the `# Years` panel to view stations with 1 to 7 years of data.
...
raster::writeRaster(
  ...
  filename = here(paste0(
    "output/interpolation/superchill_likelihood_",
    standard_depth, "_",
    min_number_years, "_",
    costras_res, "_",
    range_factor, "_",
